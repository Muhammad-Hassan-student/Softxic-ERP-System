...
import { usePermissions } from '@/modules/financial-tracker/hooks/usePermission'; // Fixed import path
import { useRecords } from '@/modules/financial-tracker/hooks/useRecord'; // Fixed import path
import { useFields } from '@/modules/financial-tracker/hooks/useField'; // Fixed import path
import { useSocket } from '@/modules/financial-tracker/hooks/useSocket'; // Fixed import path
