          ...
          {!result ? (
            <>
              ...
              <button
                ...
                className="mb-4 w-full flex items-center justify-center px-4 py-2 border border-blue-300 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
              >
            ...
            <div className="text-center">
              ...
              {result.errors.length > 0 && (
                <div className="mt-4 max-h-60 overflow-y-auto">
                  <h4 className="text-sm font-medium text-gray-700 mb-2 text-left">Errors:</h4>
