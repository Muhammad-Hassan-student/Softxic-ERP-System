  ...
  const fetchEntities = async (module: string, token: string) => {
    ...
    try {
      const response = await fetch(
        `/financial-tracker/api/financial-tracker/entities?module=${module}&active=true`,
        {
          headers: {
            Authorization: token,
          },
      ...
      <div className="max-w-4xl mx-auto pt-12 px-4 pb-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Select an entity to manage records
          </p>
        </div>
        ...
        {entities.length === 0 ? (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-500">
              You don't have access to any entities in this module.
            </p>
          </div>
        ) : (
            ...
            {entities.map((entity) => {
              ...
              return (
                <button
                  key={entity._id}
                  onClick={() =>
                    router.push(`/user-system/${module}/${entity.entityKey}`)
                  }
