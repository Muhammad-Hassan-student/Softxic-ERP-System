...
export default function ProfilePage() {
  ...
  const handlePasswordChange = async () => {
    ...
    if (currentUser?.id === user.id && !formData.currentPassword) {
              ...
              <CardContent className="p-8">
                <div className="space-y-8">
                  ...
                  {currentUser?.id === user.id && (
                    <div className="space-y-6">
                      ...
                      <div className="relative">
                        ...
                        <button
                          type="button"
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors p-2"
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-gradient-to-r from-purple-100 to-purple-50 rounded-lg">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 px-8 py-3 h-auto text-lg font-semibold min-w-[200px]"
                    >
