          ...
          <div className="px-4 py-2">
            ...
            <div className="space-y-1">
              {systemItems.map((item) => (
                ...
                >
                  <div
                    className={`flex items-center rounded-lg px-3 py-2.5 text-sm transition-all duration-200 hover:bg-gray-800 hover:text-white ${item.href === "/logout" ? "text-red-400" : "text-gray-300"} justify-start`}
                  >
                    <item.icon className="h-5 w-5 flex-shrink-0 mr-3" />
                    <span className="truncate">{item.label}</span>
                  </div>
